...
class QuartoDadoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_quarto_dado)

        val buttonVoltar3 = findViewById<Button>(R.id.buttonVoltar3)

        val buttonJoga3 = findViewById<Button>(R.id.buttonJoga3)
        buttonJoga3.setOnClickListener {
            rolarDados(20)
        }
